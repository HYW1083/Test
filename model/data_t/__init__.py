...
TRAIN_R2R_RxR = {
    "annotation_path": [
        "data/trajectory_data/R2R/annotations.json",
        "data/trajectory_data/RxR/annotations.json"
    ],
    "data_path": [
...
TRAIN_R2R_RxR_STEPS = {
    "annotation_path": "data/trajectory_data/train_steps.json",
    "data_path": "",
    "tag": "train_r2r_rxr_steps"
}

# TRAIN_R2R_RxR_EXTRA = {
#     "annotation_path": "path-to-train_r2r_rxr_extra.json",
#     "data_path": "",
#     "tag": "train_r2r_rxr_extra"
# }
...
data_dict = {
    ...
    "train_r2r_rxr_steps": TRAIN_R2R_RxR_STEPS,
