...
def replace_qwen3_vl_attention_class():
    ...
    # transformers.models.qwen3_vl.modeling_qwen3_vl.Qwen3VLModel._update_causal_mask = _update_causal_mask
    
    print("Monkey patch applied: Replaced standard Flash Attention with VarLen implementation for Qwen3-VL.")
