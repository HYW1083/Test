...
import qwen.train.trainer
import qwen.train.sampler
# from trainer import replace_qwen2_vl_attention_class

from transformers import (
    Qwen3VLForConditionalGeneration,
)
from model.data.data_qwen import make_supervised_data_module

from qwen.train.argument import (
    ModelArguments,
    DataArguments,
    TrainingArguments,
)
from transformers import AutoTokenizer, AutoProcessor, Qwen3VLProcessor, Trainer, AutoConfig, set_seed, enable_full_determinism
...
def train(attn_implementation="flash_attention_2"):
    ...
    from qwen.modeling_qwen3_vl import Qwen3VLForConditionalGeneration
    ...
    if data_args.data_flatten:
            from qwen.train.trainer import replace_qwen3_vl_attention_class
